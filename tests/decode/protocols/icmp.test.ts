...
import { ICMP } from '../../../lib/decode/protocols/icmp'
...
describe('ICMP', () => {
    ...
    describe('#decode', () => {
        ...
        it('raises a "icmp" event on decode', () => {
    ...
    describe('#toString', () => {
        const verifyToString = function verifyToString(type, code, result) {
            it(`return "${result}" for icmp of type=${type} code=${code}`, () => {
